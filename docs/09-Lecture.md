...
<img src="09-Lecture_files/figure-html/unnamed-chunk-7-1.png" width="672" />
...
<img src="09-Lecture_files/figure-html/unnamed-chunk-12-1.png" width="672" />
...
#>  [1] -0.6001290  3.0765656  0.6043317 -1.4553732  7.3446443
#>  [6]  3.0364721  6.9473715 -0.7117387  3.7566188  7.3269393
```
...
rnorm(n = 10, mean = 3, sd = 4)
#>  [1]  6.8003302  1.1493215 10.6109434 11.9698136  1.6146009
#>  [6]  5.8609298  8.9675886  5.3286760  0.2343458  0.7956046
```
...
rnorm(n = 10, mean = 3, sd = 4)
#>  [1]  2.4134448  3.9686827 -0.8676599  7.7740106  1.7136548
#>  [6]  6.1148221 -1.6579684  6.1330062  3.4552940  1.8172054
```
