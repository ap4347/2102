...
Even these lecture notes are written using R Markdown files. In this lecture we will learn how to create an R Markdown file and its basic functionalities. You will be using R Markdown files to create and submit your homework assignments.
...
```r
[Your first link](http://poxit.com)
```


It produces a link to the desired webpage and can be included in your text: [Your first link](http://poxit.com)
